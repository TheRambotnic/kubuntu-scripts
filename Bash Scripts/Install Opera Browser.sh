...
installOpera() {
	...
	# move codec file to Opera's directory
	sudo cp /snap/chromium-ffmpeg/current/chromium-ffmpeg-108372/chromium-ffmpeg/libffmpeg.so /usr/lib/x86_64-linux-gnu/opera/
